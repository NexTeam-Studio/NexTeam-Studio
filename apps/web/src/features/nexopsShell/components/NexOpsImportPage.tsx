...
export function NexOpsImportPage(props: {
  ...
  return (
    <NexOpsRosterTemplate title="Import & Sync" detail="CSV import for every tenant. Third-party adapters stay dormant unless a future tenant explicitly opts in." icon={<NexOpsNavGlyph module="imports" />}>
      <div className="nexops-import-workspace">
        <article className="nexops-module-card nexops-import-card">
          <p className="eyebrow">CSV import</p>
          <h2>Preview before write</h2>
          <p>{csvStatus}</p>
          <label className="nexops-import-upload">
