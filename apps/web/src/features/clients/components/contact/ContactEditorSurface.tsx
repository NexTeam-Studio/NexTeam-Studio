...
export function ContactEditorSurface(props: ContactEditorSurfaceProps): React.ReactElement {
  ...
  return (
    <NexOpsCreationTemplate
      ...
      backAction={<button className="nexops-hero-primary-button nexops-quote-back-to-roster" type="button" onClick={props.onClose}>← {returnLabel.replace("Back to ", "")}</button>}
    >
