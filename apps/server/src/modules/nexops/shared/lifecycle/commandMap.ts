...
import type { PERMISSION_IDS } from "./policy.js";
import { REQUEST_CORE_COMMANDS, REQUEST_CORE_COMMUNICATIONS } from "../../areas/requests/components/requestCore/server/lifecycleContracts.js";
import { QUOTE_ENGINE_COMMANDS, QUOTE_ENGINE_COMMUNICATIONS } from "../../areas/quotes/components/quoteEngine/server/lifecycleContracts.js";
import { JOB_CORE_COMMANDS, JOB_CORE_COMMUNICATIONS } from "../../areas/jobs/components/jobCore/server/lifecycleContracts.js";
import { VISIT_CORE_COMMANDS, VISIT_CORE_COMMUNICATIONS } from "../../areas/visits/components/visitCore/server/lifecycleContracts.js";
import { INVOICE_STRUCTURE_COMMANDS, INVOICE_STRUCTURE_COMMUNICATIONS } from "../../areas/invoices/components/invoiceStructure/server/lifecycleContracts.js";
import { PAYMENT_RAILS_COMMANDS, PAYMENT_RAILS_COMMUNICATIONS } from "../../areas/invoices/components/paymentRails/server/lifecycleContracts.js";
import { DOCUMENT_RENDERING_COMMANDS, DOCUMENT_RENDERING_COMMUNICATIONS } from "../../../../shared/documentRendering/lifecycleContracts.js";
import { PORTAL_CORE_COMMANDS, PORTAL_CORE_COMMUNICATIONS } from "../../../nexportal/components/portalCore/server/lifecycleContracts.js";

export { DECISION_REGISTRY, PERMISSION_IDS, PORTAL_AUTHORIZATION_PROFILE_ID } from "./policy.js";
export * from "../../areas/quotes/components/quoteEngine/domain/dominantAction.js";
export * from "../../areas/visits/components/visitCore/domain/dominantAction.js";
export * from "../../areas/invoices/components/invoiceStructure/domain/dominantAction.js";
export * from "../../../nexportal/components/portalCore/domain/dominantAction.js";
