...
const TOOL_MODULES: Record<string, PlatformModule> = {
  ...
  invoiceStatus: "crm",
  listPayments: "crm",
  getPaymentDetail: "crm",
  listDeposits: "crm",
  listRefunds: "crm",
  listCredits: "crm",
  queueLedgerAction: "crm",
  revisePendingLedgerActionApproval: "crm",
  draftQuote: "crm",
  searchEmail: "comms",
  ...
  generateJobContent: "content",
  listPendingDrafts: "content",
  approveDraft: "content",
  discardDraft: "content",
  listConsentedClients: "content",
  revisePendingDraftApproval: "content",
  ...
  pollGbpReviews: "reputation",
  reputationQueue: "reputation",
  draftReviewReply: "reputation",
  draftReviewRequest: "reputation",
  draftGbpProfileSync: "reputation",
  findSlot: "scheduling",
