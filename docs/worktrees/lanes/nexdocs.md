...
Owns document library, checklists, reports, media references, and client documents. Its authoritative paths, branch, and worktree directory are recorded in worktree-lanes.json. Run npm run check:worktree-scope before committing.
