...
| --- | --- | --- | --- | --- | --- | --- | --- |
| A Tenant core, onboarding, settings | platform-tenants; nexops-settings; target-architecture-integration | REPAIRING | bb92ba5 | `packages/core/src/types.ts`; `packages/core/src/schemas.ts`; `packages/providers/src/native/NativeAdapter.ts`; tenant settings route/schema/UI; CRM route test | Typecheck and build passed after the Settings UI change. Earlier full test suite: 466 passed, 0 failed, 3 skipped; lint, tenancy, worktree scope, and coverage passed. | Module selection and the guided onboarding progression still need to be joined to this shared record. | A |
